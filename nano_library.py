...
class K40_CLASS:
    ...
    def say_hello(self):
        ...
        if response != None:
            ...
            if (
                response[1] == self.OK
                or response[1] == self.BUFFER_FULL
                or response[1] == self.CRC_ERROR
                or response[1] == self.TASK_COMPLETE
                or response[1] == self.UNKNOWN_2
            ):
                return response[1]
            else:
                return 9999
                ...
                if cnt > 31:
                    ...
                    if not preprocess_crc:
                        ...
                        if stamp != timestamp:
                            timestamp = stamp  # interlock
                            update_gui(
                                "Calculating CRC data and Generate Packets: %.1f%%"
