...
class SVG_READER(inkex.Effect):
    ...
    def process_group(self, group):
        ...
        if trans:
            self.groupmat.append(
                simpletransform.composeTransform(self.groupmat[-1], simpletransform.parseTransform(trans))
            )
        for node in group:
            ...
            try:
                ...
                if stdout.find(b"Inkscape 1.") == -1:
                    ...
                    cmd = [
                        ...
                        "255",
                        "--export-type=png",
                        "--export-filename=%s" % (png_temp_file),
                        svg_temp_file,
                    ]
            ...
            try:
                ...
                if stdout.find(b"Inkscape 1.") == -1:
                    ...
                    cmd = [
                        ...
                        "--export-text-to-path",
                        "--export-plain-svg",
                        "--export-filename=%s" % (txt2path_file),
                        svg_temp_file,
                    ]
    ...
    def make_paths(self, txt2paths=False):
        ...
        self.groupmat = [[[scale_w, 0.0, 0.0 - Dx], [0.0, -scale_h, h_mm + Dy]]]
